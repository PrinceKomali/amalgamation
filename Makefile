...
define rm 
	...
	@rm -rf $(1)
endef
$(TARGET): dircheck build/a.o build/b.o build/c.a build/d.o build/e.o build/f.o build/g.o build/h.o build/i.o build/j.a build/k.a build/l.o build/m.o build/n.o build/o.a build/p.o build/q.o build/r.o build/s.a
...
build/s.a: src/s.hs 
	...
	{ printf "_hs_init = 0;"; nm src/s.o | grep -E '^[0-9a-f]{16} T' | awk '{print $$3}' | xargs -I {} echo 'void {}() {  if(!_hs_init){_hs_init=1;int argc = 1;char **argv = (char **)malloc(sizeof(char *));argv[0] = strdup("hi");hs_init(&argc, &argv);}export_{}();}'; } > helpers/funcs.c 
